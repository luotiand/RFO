...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2,  width):
        ...
        self.fc0 = nn.Linear(4, self.width) # input channel is 3: (a(x, y), t,x, y)
...
class FNO2d_2(nn.Module):
    def __init__(self, modes1, modes2,  width):
        super(FNO2d_2, self).__init__()
        ...
        self.width = width
        self.padding = 9 # pad the domain if input is non-periodic
        self.fc0 = nn.Linear(5, self.width) # input channel is 3: (a(x, y), t,x, y)
